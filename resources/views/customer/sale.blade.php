@extends('customer.layouts.simple.master', ['title' => 'Tambah Penjualan'])
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td> <button class="btn btn-outline-primary" disabled id="bayar">Bayar</button></td>
                                        </tr>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#pay_amount').on('input',function(){
                if (parseInt($('#pay_amount').val()) >= parseInt($('#grandTotal').text())) {
