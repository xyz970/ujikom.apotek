@extends('layouts.simple.master', ['title' => 'Daftar Supplier'])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3 col-4">
                            <div class="modal fade bd-example-modal-lg modal-detail" data-modal="tambahSupplier"
                                id="tambahSupplier" tabindex="-1" role="dialog" aria-labelledby="tambahSupplier"
                                aria-hidden="true">
                            ...
                            <button class="btn btn-outline-primary" data-btn="showModal" data-bs-toggle="modal"
                                data-bs-target="#tambahSupplier">Tambah Supplier</button>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        function deleteData(id) {
            var deleteUrl =  "{{ route('admin.supplier.destroy', ':id') }}";
            swal({
                title: "Anda Yakin?",
