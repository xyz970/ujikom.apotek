@extends('layouts.simple.master', ['title' => 'Tambah Penjualan'])
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label" for="inputEmail3">Pilih Nama Customer</label>
                                <div class="col-sm-9">
                                    <select class="customer form-select" id="customer" name="customer"></select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
